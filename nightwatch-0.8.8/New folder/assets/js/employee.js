...
jQuery(document).ready(function() {
	...
	$('#addEmployee').on('click', function(e) { 
		...
		var firstname = $('#employees-form').find('#firstname').val();
		var lastname = $('#employees-form').find('#lastname').val();
		var dependents = $('#employees-form').find('#dependents').val();
		...
		$('#employees-form').find('#firstname').val('');
		$('#employees-form').find('#lastname').val('');
		$('#employees-form').find('#dependents').val('');
	});
});
...
function editRow(r) {
	...
	$('#employees-form').find('#firstname').val(firstname);
	$('#employees-form').find('#lastname').val(lastname);
	$('#employees-form').find('#dependents').val(dependents);
